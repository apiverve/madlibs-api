...
class madlibsWrapper {

    constructor(options) {
        if (!options || typeof options !== 'object') {
            throw new Error('Options object must be provided. See documentation: https://docs.apiverve.com/ref/madlibs');
        }
        ...
        this.baseURL = 'https://api.apiverve.com/v1/madlibs';

        // Validation rules for parameters (generated from schema)
        this.validationRules = {"category":{"type":"string","required":false,"default":"random"},"count":{"type":"integer","required":false,"min":1,"max":5,"default":1}};
    }
    ...
    validateParams(query) {
        ...
        if (errors.length > 0) {
            throw new Error(`Validation failed: ${errors.join(' ')} See documentation: https://docs.apiverve.com/ref/madlibs`);
        }
    }
