...
/**
 * Client for the Mad Libs Generator API
 *
 * @example Basic usage
 * ```php
 ...
 * ```
 *
 * @see https://apiverve.com/marketplace/madlibs?utm_source=php&utm_medium=readme
 */
class Client
{
    private const BASE_URL = 'https://api.apiverve.com/v1/madlibs';
    ...
    {
        if ($this->debug) {
            echo "[APIVerve\MadlibsClient] {$message}\n";
        }
    }
}
