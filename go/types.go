// Package madlibs provides a Go client for the Mad Libs Generator API.
//
// For more information, visit: https://apiverve.com/marketplace/madlibs?utm_source=go&utm_medium=readme
package madlibs
...
// Request contains the parameters for the Mad Libs Generator API.
//
// Parameters:
//   - category: string - Story category
//   - count: integer - Number of stories [min: 1, max: 5]
type Request struct {
...
// ResponseData contains the data returned by the Mad Libs Generator API.
type ResponseData struct {
	Stories []StoriesItem `json:"stories"`
	Count int `json:"count"`
	Category string `json:"category"`
	Html string `json:"html"`
}

// StoriesItem represents an item in the Stories array.
type StoriesItem struct {
	Title string `json:"title"`
	Template string `json:"template"`
	Blanks []BlanksItem `json:"blanks"`
	BlankCount int `json:"blankCount"`
	Category string `json:"category"`
}

// BlanksItem represents an item in the Blanks array.
type BlanksItem struct {
	Id int `json:"id"`
