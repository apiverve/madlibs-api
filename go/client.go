...
const (
	baseURL        = "https://api.apiverve.com/v1/madlibs"
	defaultTimeout = 30 * time.Second
)

// Client is the Mad Libs Generator API client.
type Client struct {
	apiKey     string
	httpClient *resty.Client
}

// NewClient creates a new Mad Libs Generator API client.
...
// Execute makes a request to the Mad Libs Generator API with typed parameters.
//
