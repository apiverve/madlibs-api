# Mad Libs Generator Android SDK
...
```gradle
dependencies {
    implementation 'com.github.apiverve:madlibs-api:1.1.12'
}
```
...
```java
import com.apiverve.madlibs.MadLibsGeneratorAPIClient;
import com.apiverve.madlibs.APIResponse;
import com.apiverve.madlibs.APIException;

// Initialize the client
MadLibsGeneratorAPIClient client = new MadLibsGeneratorAPIClient("YOUR_API_KEY");
...
For detailed API documentation, visit: [https://docs.apiverve.com/ref/madlibs](https://docs.apiverve.com/ref/madlibs)
...
- **Documentation:** [https://docs.apiverve.com/ref/madlibs](https://docs.apiverve.com/ref/madlibs)
- **Issues:** [GitHub Issues](https://github.com/apiverve/madlibs-api/issues)
